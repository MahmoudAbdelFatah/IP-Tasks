...
im0=im2bw(imresize(imread('Train\0.jpg'),[16,16]), 0.5);
im1=im2bw(imresize(imread('Train\1.png'),[16,16]), 0.5);
im11=im2bw(imresize(imread('Train\1.jpg'),[16,16]), 0.5);
im2=im2bw(imresize(imread('Train\2.jpg'),[16,16]), 0.5);
im3=im2bw(imresize(imread('Train\3.jpg'),[16,16]), 0.5);
im4=im2bw(imresize(imread('Train\4.jpg'),[16,16]), 0.5);
im5=im2bw(imresize(imread('Train\5.jpg'),[16,16]), 0.5);
im6=im2bw(imresize(imread('Train\6.jpg'),[16,16]), 0.5);
im7=im2bw(imresize(imread('Train\7.jpg'),[16,16]), 0.5);
im8=im2bw(imresize(imread('Train\8.jpg'),[16,16]), 0.5);
im9=im2bw(imresize(imread('Train\9.jpg'),[16,16]), 0.5);

im=im2bw(imresize(imread('Train\cmr.PNG'),[16,16]), 0.5);
...
%     figure, imshow(~imgProp(i).Image);
    if(this(3)>=2 &&this(4)>=30 && this(3)<=100 &&this(4)<=300)
        ...
        imwrite(temp,'Train\temp.bmp');
        imgTest =imread('Train\temp.bmp');
